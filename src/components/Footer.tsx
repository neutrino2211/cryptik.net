	...
	return (
		<footer className="bg-black text-white py-12">
			<div className="max-w-7xl mx-auto px-6">
				{/* Main Footer Content */}
				<div className="grid md:grid-cols-4 gap-10 mb-8 pb-8 border-b border-white/10">
					{/* Brand Section */}
					<div className="md:col-span-2">
						<h3 className="text-2xl font-extrabold tracking-tight bg-gradient-to-r from-cryptik-green to-cryptik-gold bg-clip-text text-transparent mb-4">
							CRYPTIK
						</h3>
						...
						<div className="flex gap-3">
							<a
								...
								className="w-9 h-9 bg-white/10 rounded flex items-center justify-center hover:bg-cryptik-green hover:-translate-y-0.5 transition-all duration-300"
							>
							...
							<a
								...
								className="w-9 h-9 bg-white/10 rounded flex items-center justify-center hover:bg-cryptik-green hover:-translate-y-0.5 transition-all duration-300"
							>
								<svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" xmlns="http://www.w3.org/2000/svg">
