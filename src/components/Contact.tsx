export default function Contact() {
	return (
		<section id="contact" className="py-16 bg-cryptik-dark">
			<div className="max-w-7xl mx-auto px-6">
				<div className="grid md:grid-cols-2 gap-12 items-start">
					...
					<div>
						...
						<div className="space-y-8 mb-12">
							...
							<div className="flex gap-4 items-start">
								<div className="w-11 h-11 bg-cryptik-green rounded flex items-center justify-center flex-shrink-0">
						...
						{/* Response Time */}
						<div className="bg-cryptik-gray/50 p-4 rounded border-l-4 border-cryptik-green">
					...
					{/* Contact Form */}
					<div className="bg-cryptik-gray/50 p-6 rounded">
						<form className="space-y-6">
							...
							<div>
								...
								<input
									...
									className="w-full px-3 py-2 bg-cryptik-dark border-2 border-white/10 rounded focus:border-cryptik-green focus:outline-none focus:ring-2 focus:ring-cryptik-green/20 transition-all"
								/>
							</div>
							...
							<div>
								...
								<textarea
									...
									className="w-full px-3 py-2 bg-cryptik-dark border-2 border-white/10 rounded focus:border-cryptik-green focus:outline-none focus:ring-2 focus:ring-cryptik-green/20 transition-all resize-y"
								></textarea>
							</div>
							...
							<button
								type="submit"
								className="w-full bg-cryptik-green text-white px-6 py-3 rounded font-semibold hover:bg-cryptik-gold hover:text-cryptik-dark hover:-translate-y-0.5 hover:shadow-lg hover:shadow-cryptik-green/30 transition-all duration-300"
							>
								Send Message
							</button>
						</form>
